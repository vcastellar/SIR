...
narrative document for the **SIR** package. In addition to the original demo
...
# Peak prevalence of infectious individuals by scenario
sapply(sims, peak_prevalence)

# Time to infectious peak by scenario
sapply(sims, time_to_peak)
```
